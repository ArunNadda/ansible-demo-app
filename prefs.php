...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>Current Preferences</title>
    ...
    <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
            ...
            <div class="inner cover">
                <h1 class="cover-heading">Current Preferences</h1>
                <p class="lead"><i>This page is demonstrating the use of vars and templates, and vars precedence rules in Ansible</i></p>
            ...
            <div class="mastfoot">
                <div class="inner">
                    <p>Ansible Demo application customized by the <a href="https://github.com/ArunNadda/learning-ansible">LearningAnsible</a>.</p>
                </div>
            </div>
        </div>
    </div>
