    ...
    <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
            ...
            <div class="inner cover">
                <h1 class="cover-heading">Welcome to the Ansible Demo Application.</h1>
                <p class="lead"><i>This app is used for demonstrating and testing various Ansible concepts.</i></p>
                ...
                <h3>Application Version: <span class="label label-info">1.5</span></h3>
            ...
            <div class="mastfoot">
                <div class="inner">
                    <p>Ansible Demo application provided by the <a href="https://www.devopslibrary.com/">DevOps Library</a>.</p>
                </div>
            </div>
        </div>
    </div>
